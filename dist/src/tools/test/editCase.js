...
export const testEditCaseTool = {
    name: 'test.editCase',
    description: 'Replace the body of a single test case identified by title (and optional describePath). ' +
    ...
    async run(input, ctx) {
        ...
        if (locator.isEach) {
            throw new Error(`refusing to edit parameterized test (test.each): '${input.title}'. ` +
