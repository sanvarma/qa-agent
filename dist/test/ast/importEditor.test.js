...
describe('addImport — conflicts and edge cases', () => {
    test('conflicting default throws ImportError', () => {
        ...
        assert.throws(() => addImport(sf, { moduleSpecifier: 'lodash', defaultName: '_' }), (err) => err instanceof ImportError && err.code === 'conflicting_default');
    });
    test('empty request throws nothing_to_add', () => {
        const sf = makeSourceFile(``);
        assert.throws(() => addImport(sf, { moduleSpecifier: '@playwright/test' }), (err) => err instanceof ImportError && err.code === 'nothing_to_add');
    });
...
//# sourceMappingURL=importEditor.test.js.map