 ...
 */
export function addImport(sf, args) {
    ...
    const existing = sf
        ...
        .find((d) => d.getModuleSpecifierValue() === args.moduleSpecifier && d.isTypeOnly() === typeOnly);
    const addedNamed = [];
    let addedDefault = null;
    if (existing) {
        // Merge named imports.
        ...
        if (requestedDefault) {
            ...
            if (!currentDefault) {
                ...
                throw new ImportError('conflicting_default', `module '${args.moduleSpecifier}' is already imported with default '${currentDefault}', cannot also use '${requestedDefault}'`);
            }
...
function sortNamedImports(decl) {
...
//# sourceMappingURL=importEditor.js.map